...
def extract_patch_tokens_and_coords(model, loader, device):                 #It extracts only the final-layer patch tokens (after the last Transformer block).
    """
...
def train_probe_regressor(X_train, y_train, X_val, y_val, in_dim, device,
    ...
    return model, l2_error, within_tol                                                                  ####tolerance (3,4) , (3,5) almost correct
